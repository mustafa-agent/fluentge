# FluentGe — Feature Ideas for Diversity

## ✅ Already Built
1. 📝 Flashcards (SM-2 spaced repetition)
2. 🧠 Quiz (multiple choice)
3. ✍️ Spelling (type the word)
4. 🔤 Sentence Builder (arrange words)
5. 🎧 Podcast (21 episodes)
6. 🃏 Word Match Memory Game (building now)
7. 📅 Daily Word (building now)

## 🔜 Next Ideas (Priority Order)

### Easy to Build (1-2 hours each)

8. **🎯 Word of the Day Push** — Daily notification with a new word
9. **📊 Leaderboard / Weekly Stats** — Show weekly progress, words learned graph
10. **🏆 Achievements / Badges** — "First 50 words!", "7-day streak!", "Speed learner!" etc.
11. **🔊 Pronunciation Practice** — Listen to English word, try to repeat (uses existing TTS)
...
18. **🎮 Word Snake** — Connect letters on a grid to spell words ✅ BUILT (Feb 19)
31. **📝 Story Builder** — Mad Libs-style fill-in-the-blank stories for vocabulary practice ✅ BUILT (Feb 19)
...
22. **👥 Multiplayer Quiz** — Challenge friends
23. **📹 Video Lessons** — Short grammar/vocabulary videos
24. **🗣️ Speaking Practice** — Record yourself, compare with native audio
