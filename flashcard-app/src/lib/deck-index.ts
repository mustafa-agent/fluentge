...
export const deckIndex: DeckMeta[] = [
  ...
  { id: 'ielts-reading', name: 'IELTS Reading Vocab', nameKa: 'IELTS კითხვის ლექსიკა', icon: '📋', image: 'https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=400&q=80', cardCount: 50, sources: ['ielts-reading-vocab'] },
  { id: 'ielts-writing', name: 'IELTS Writing Vocab', nameKa: 'IELTS წერის ლექსიკა', icon: '✍️', image: 'https://images.unsplash.com/photo-1455390582262-044cdead277a?w=400&q=80', cardCount: 50, sources: ['ielts-writing-vocab'] },
  { id: 'toefl-speaking', name: 'TOEFL Speaking Phrases', nameKa: 'TOEFL სასაუბრო ფრაზები', icon: '🎤', image: 'https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=400&q=80', cardCount: 40, sources: ['toefl-speaking-vocab'] },
